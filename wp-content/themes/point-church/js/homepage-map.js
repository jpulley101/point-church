define(['exports'], function (exports) {
  ...
  var HomepageMap = exports.HomepageMap = function () {
    function HomepageMap() {
      _classCallCheck(this, HomepageMap);

      this.MY_MAPTYPE_ID = 'homepage_map';

      HomepageMap.buildHomepageMap();
    }

    _createClass(HomepageMap, null, [{
      key: 'buildHomepageMap',
      value: function buildHomepageMap() {
        ...
        function initialize() {
          ...
          var apexContent = '<div id="map-info">' + '<h4 class="campus-name">Apex Campus<h4>' + '<p class="address">1402 E Williams St, Apex, NC 27539</p>' + '</div>';
          ...
          var sRaleighContent = '<div id="map-info">' + '<h4 class="campus-name">South Raleigh Campus<h4>' + '<p class="address">3700 Lake Wheeler Rd, Raleigh, NC 27603</p>' + '</div>';
          ...
          var nRaleighContent = '<div id="map-info">' + '<h4 class="campus-name">North Raleigh Campus<h4>' + '<p class="address">6904 Glenwood Ave Raleigh, NC 27612</p>' + '</div>';
          ...
          var caryContent = '<div id="map-info">' + '<h4 class="campus-name">Cary Campus<h4>' + '<p class="address">1503 Walnut St, Cary, NC 27511</p>' + '</div>';
...
//# sourceMappingURL=../js/maps/homepage-map.js.map
